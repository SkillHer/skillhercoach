  ...
  return (
    <div className="p-6 bg-white rounded-lg border border-anita-lavender/20 shadow-sm max-h-[80vh] overflow-y-auto">
      ...
      <RadioGroup className="gap-4 mb-6" value={selectedInterest || ""} onValueChange={value => handleInterestSelect(value as 'career' | 'health' | 'business' | 'other')}>
        ...
        <div className={`interest-selector-option business flex items-start space-x-3 bg-anita-pink/10 p-3 rounded-md cursor-pointer transition-colors`} onClick={() => handleInterestSelect('business')}>
