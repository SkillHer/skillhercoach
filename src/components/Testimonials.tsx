...
const Testimonials = () => {
  ...
  return <section id="testimonials" className="py-16 bg-clara-lavender/5">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">Women Empowered by SkillHer Coach</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Hear from women who have experienced remarkable tranformations both personally & professionally with SkillHer Coach.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => <Card key={index} className="p-8 bg-white shadow-md hover:shadow-lg transition-shadow">
              <div className="flex flex-col h-full">
                ...
                <div className="flex items-center">
                  <div className="h-12 w-12 rounded-full overflow-hidden mr-4 bg-gray-100 flex-shrink-0">
                    <img src={testimonial.image} alt={testimonial.name} className="h-full w-full object-cover" onError={e => {
