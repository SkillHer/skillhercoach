              ...
              {wellnessModules.map((module, index) => (
                <Card key={`wellness-${index}`} className="hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <Button variant="outline" className="w-full border-clara-lavender text-clara-lavender hover:bg-clara-lavender/10">
                      Learn More
                    </Button>
                  </CardContent>
                </Card>
              ...
              {careerModules.map((module, index) => (
                <Card key={`career-${index}`} className="hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">{module.description}</p>
                    <Button variant="outline" className="w-full border-clara-sage text-clara-sage hover:bg-clara-sage/10">
                      Learn More
                    </Button>
                  </CardContent>
                </Card>
