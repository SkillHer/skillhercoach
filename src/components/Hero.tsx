        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-12 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Button size="lg" variant="outline" className="border-clara-lavender text-clara-lavender hover:bg-clara-lavender/10" onClick={handleLearnMore}>
                Learn More
              </Button>
            </div>
          </div>
            ...
            <div className="relative w-full">
              ...
              <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 p-4 sm:p-6 w-full">
                <div className="h-[400px] sm:h-[450px] md:h-[500px] bg-clara-cream rounded-lg overflow-hidden w-full">
                  <img src="/lovable-uploads/bcdab618-e711-4683-909b-ce31cae7f3ec.png" alt="Skillher Coach" className={`w-full h-full object-contain transition-opacity duration-300 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`} onLoad={() => setImageLoaded(true)} onError={e => {
